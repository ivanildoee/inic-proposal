...
export const Footer: React.FC<FooterProps> = ({ onNavigate }) => {
  return (
    <footer className="bg-inic text-white pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <p className="text-gray-300 text-sm leading-relaxed">
            O Instituto de Inovação e Conhecimento (INIC) promove a Sociedade da Informação e o desenvolvimento digital de São Tomé e Príncipe.
          </p>
        </div>

        {/* Useful Links */}
        <div>
          <h4 className="font-bold text-lg mb-6 border-b border-inic-light pb-2 inline-block">LINKS ÚTEIS</h4>
        ...
        {/* Location */}
        <div>
          <h4 className="font-bold text-lg mb-6 border-b border-inic-light pb-2 inline-block">LOCALIZAÇÃO</h4>
        ...
        {/* Social */}
        <div>
          <h4 className="font-bold text-lg mb-6 border-b border-inic-light pb-2 inline-block">REDES SOCIAIS</h4>
      ...
      <div className="max-w-7xl mx-auto px-4 mt-16 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-400">
        <p>Copyright © {new Date().getFullYear()} All rights reserved - INIC</p>
